...
public class SafariLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.save(Safari.builder()
            ...
            .price(450.00)
            .description("<div class='SafariDetails'><img src='images/cheeter.jpg' class='SafariSnap' alt='Longtail boat in Thailand' align='top'/> The 3-days Masai Mara safari tour in Kenya is the shortest and cheapest solution offering the best way to experience the view of African safaris big 5. Thousands of visitors come to the Mara every year to enjoy some of the most authentic safari experiences in Africa. The Mara is renowned for delivering exceptional big cat (lion, leopard and cheetah) sightings. Cheetahs are particularly well adapted to the region’s flat plains, which makes the Masai Mara one of the best places to see these nimble predators. They often seek vantage points on fallen trees, termite mounds, and even game drive vehicles! It’s a highlight of any Masai Mara safari to watch the world’s fastest land mammal chase down its prey.</div>")
