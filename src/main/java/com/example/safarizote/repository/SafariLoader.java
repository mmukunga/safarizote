...
public class SafariLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.save(Safari.builder()
            ...
            .details("<div class='SafariDetails'><h1>Mombasa Beach</h1>Kenya has so much to offer the visitor - from the vast plains of the iconic Masai Mara and Amboseli teeming with wildlife to the white sand beaches of the Indian Ocean.</div>")
            .dateCreated(Instant.now())
            .build());
