...
public class SafariLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.save(Safari.builder()
            ...
            .details("<div class='SafariDetails'><h3>Nairobi National Park</h3>Nairobi National Game Park is a unique ecosystem by being the only protected area in the world close to a capital city. Located just 7kms from Nairobi’s city centre, Nairobi National Park is the perfect place for a half-day or full day excursion or Tour from the Kenyan capital. One of the only places on earth where you can be on safari with skyscrapers as part of your backdrop, it’s an ideal layover escape or add-on to your existing safari.<p><strong>Important Details</strong></p> Included <ul><li>Safari van with open roof</li><li>pickup and Drop off-Nairobi Hotel/Apartment/Airport</li><li>Driver Guide</li></ul> Not Included <ul><li>Admission fees park $43,Elephant$5,Giraffe $15,Karen $13</li><li>Gratuities</li><li>Lunch</li></ul> Additional Info <ul><li>Public transportation options are available nearby</li><li>Suitable for all physical fitness levels</li></ul> Meeting Point <p> We will pick up and drop off At any Nairobi Hotel/Apartment/Airport</p></div>")
            .dateCreated(Instant.now())
            .build());
        ...
        repository.save(Safari.builder()
            ...
            .details("<div class='SafariDetails'><h3>Mombasa Beach</h3>Kenya has so much to offer the visitor - from the vast plains of the iconic Masai Mara and Amboseli teeming with wildlife to the white sand beaches of the Indian Ocean.</div>")
            .dateCreated(Instant.now())
            .build());
