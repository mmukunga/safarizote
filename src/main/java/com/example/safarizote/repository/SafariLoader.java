...
public class SafariLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.save(Safari.builder()
            .title("<div class='SafariDetails'><img src='images/cheeter.jpg' class='SafariSnap' alt='3 Days 2 Nights Maasai Mara – Masai mara safari package' align='top'/> The Masai Mara reserve will tickle your thrill spot with Kenya’s richest concentration of wildlife. The lush golden grassland plains are filled with plentiful zebras, lions and wild beasts, with a real-life alacrity of on-camera safari expeditions.This acacia land brings you goosebumps with the cheerful sight of the five giants, the elephants, rhinos, lions, leopards and the wild buffaloes. Feel the intriguing sense of nomadic life with captivating day-time activities and splendid overnight stays at camps or lodges on this trip to Masai Mara. <p>Below are the details for the 3 Day Masaai Mara Safari:</p>")
            .price(450.00)
