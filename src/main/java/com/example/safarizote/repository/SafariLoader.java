...
public class SafariLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.save(Safari.builder()
            .title("The Masai Mara reserve will tickle your thrill spot with Kenya’s richest concentration of wildlife. The lush golden grassland plains are filled with plentiful zebras, lions and wild beasts, with a real-life alacrity of on-camera safari expeditions. <p>This acacia land brings you goosebumps with the cheerful sight of the five giants, the elephants, rhinos, lions, leopards and the wild buffaloes.</p><p>Feel the intriguing sense of nomadic life with captivating day-time activities and splendid overnight stays at camps or lodges on this trip to Masai Mara. <span class='Italic'>Below are the details for the 3 Day Masaai Mara Safari</span></p>")
            .price(450.00)
