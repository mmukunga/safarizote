...
public class SafariLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        repository.save(Safari.builder()
            ...
            .price(150.00)
            .description("<div class='SafariDetails'><img src='images/gnus.jpg' class='SafariSnap' alt='1 Day Nairobi National Park,Elephant Center-Giraffes & Karen Blixen Full day tour' align='top'/> This full day tour is an excellent way to begin or end your East Africa safari. Search out wildlife at Nairobi National Park, on the outskirts of Nairobi. Enjoy lunch at a local restaurant and visit the Karen Blixen Museum. Stop by the Giraffe Center for a close up look at the endangered Rothschild giraffe1 full day Nairobi National Park tour, Baby elephant Giraffes & Karen Blixen Museum Tour in Nairobi. <p><strong>Important Details</strong></p> Included <ul><li>Safari van with open roof</li><li>pickup and Drop off-Nairobi Hotel/Apartment/Airport</li><li>Driver Guide</li></ul> Not Included <ul><li>Admission fees park $43,Elephant$5,Giraffe $15,Karen $13</li><li>Gratuities</li><li>Lunch</li></ul> Additional Info <ul><li>Public transportation options are available nearby</li><li>Suitable for all physical fitness levels</li></ul> Meeting Point <p> We will pick up and drop off At any Nairobi Hotel/Apartment/Airport</p>  <Link to={{ pathname: \"/email\", state: {props.id} }}>Please Enquire Here</Link>  </div>")
            .dateCreated(Instant.now())
            .build());
        ...
        repository.save(Safari.builder()
            ...
            .price(1550.00)
            .description("<div class='SafariDetails'><img src='images/cheeters.jpg' class='SafariSnap' alt='7 Days Kenya Beach Holiday and Amboseli' align='top'/> Kenya has so much to offer the visitor - from the vast plains of the iconic Masai Mara and Amboseli teeming with wildlife to the white sand beaches of the Indian Ocean.  <Link to={{ pathname: \"/email\", state: {props.id} }}>Please Enquire Here</Link> </div>")
            .dateCreated(Instant.now())
            .build());
