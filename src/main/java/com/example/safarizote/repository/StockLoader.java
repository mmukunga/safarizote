   ...
   @Override
    public void run(String... args) throws Exception {
        ...
        if (repository.findAll().isEmpty()) {    
            ...
            repository.save(Ticker.builder().name("SAS AB").symbol("SASNOK.OL").costPrice(1.95).shares(500).description("Scandinavian Air Service").selected(false).dateCreated(Instant.now()).build());
