    ...
    const Accordion = ({ children, title, isExpand = false, video, idx}) => {
      ...
      return (
        <div className="containerX">
          <div className="floatedX">float float float float float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float floatfloat float.</div>
